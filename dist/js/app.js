(() => {
  ...
  window.addEventListener("load", function (e) {
    ue(),
      document.querySelector(".slides-first-slider") &&
        new oe(".slides-first-slider", {
          modules: [de, pe],
          observer: !0,
          observeParents: !0,
          slidesPerView: 1,
          ...
          speed: 800,
          loop: !0,
          pagination: { el: ".slides-first-slider__controll", clickable: !0 },
          navigation: {
            nextEl: ".slides-first-slider__next",
            prevEl: ".slides-first-slider__prev",
          },
          breakpoints: {
            320: { spaceBetween: 10 },
            480: { spaceBetween: 20 },
